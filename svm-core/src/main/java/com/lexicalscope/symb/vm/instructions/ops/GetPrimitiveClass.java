...
public final class GetPrimitiveClass implements Vop {
   ...
   private String inGameStringToRealLifeString(final Context ctx, final Object primitiveNameRef) {
   ...
   private char[] extractCharArray(final Context ctx, final Object primitiveNameRef, final int valueFieldIndex) {
   ...
   private Object[] extractArray(final Context ctx, final Object arrayPointer) {
